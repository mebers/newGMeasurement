...
measuring $G$ three or four orders of magnitude more precisely than presently known,
...
length, time, and temperature themselves are extreme scales, not
...
same order as the uncertainty in the prototype kilogram itself.\cite{BIPM}  Hence
...
make such an improvement possible.  A Planckian second is not a prospect
...
\end{equation}
If one is able to measure the position of the two masses very accurately and thus knows the orbit, it is possible to deduce the gravitational constant. 
