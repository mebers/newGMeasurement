...
To arrive at a best value for $k$ and an uncertainty, we take the median and the percentiles corresponding to one sigma from the distribution of the parameter $k$. For this example we get:
